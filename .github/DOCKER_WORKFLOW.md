...
```
yourusername/3dworks-web:1.5.0
yourusername/3dworks-web:1.5
yourusername/3dworks-web:1
...
docker run -p 3000:3000 yourusername/3dworks-web:latest
```
...
services:
  web:
    image: yourusername/3dworks-web:latest
    ports:
      - "3000:3000"
```
...
- Check DockerHub for published images: https://hub.docker.com/r/yourusername/3dworks-web
